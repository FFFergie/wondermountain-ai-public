...
require_text ".github/workflows/mirror-to-gitee.yml" "git push gitee refs/heads/*:refs/heads/*"
require_text ".github/workflows/mirror-to-gitee.yml" "git push gitee refs/tags/*:refs/tags/*"
